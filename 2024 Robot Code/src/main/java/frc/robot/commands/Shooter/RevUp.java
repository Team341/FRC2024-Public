...
public class RevUp extends Command {
  ...
  public RevUp(Shooter shoot, double leftSpeed, double rightSpeed, DoubleSupplier angle, ShooterHood hood) {
    this.shoot = shoot;
  ...
  public void execute() {
    ...
    angle = ()->ShooterHood.getInstance().getAngleFromFutureRange();
