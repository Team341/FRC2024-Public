...
//RevUP made specifically for the FIRST SHOT in autonomous
public class RevUpFirstShot extends Command {
  /** Creates a new RevUp. */
  Shooter shoot;
  double mLeftSpeed;
  double mRightSpeed;
  ...
  public RevUpFirstShot(Shooter shoot, double leftSpeed, double rightSpeed, DoubleSupplier angle, ShooterHood hood) {
    this.shoot = shoot;
