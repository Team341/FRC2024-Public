...
public class DriveToPositionAbsolute extends Command {
    ...
    public void execute() {
        ...
        // if (Math.abs(robotPose.getX() - targetPose.getX()) <= Units.inchesToMeters(1.)
        //         && Math.abs(robotPose.getY() - targetPose.getY()) <= Units.inchesToMeters(1.)) {
        //     counter++;
        //     if (counter > 10) {
