...
public class PIDGains {
    ...
    public PIDGains(double p, double i, double d, double f, double v, double s, String name) {
        this(p, i, d, f, v, s, 0.0, 0.0, name);
    }
    ...
    public PIDGains(double p, double i, double d) {
     ...
     public PIDGains(double p, double i, double d, String name) {
        this(p, i, d, 0.0, 0.0, 0.0, name);
    }
