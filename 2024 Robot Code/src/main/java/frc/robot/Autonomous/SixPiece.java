...
public class SixPiece extends SequentialCommandGroup {
        ...
        public SixPiece(Swerve swerve, ShooterHood hood, Shooter shooter, Intake intake) {
                ...
                addCommands(
                                ...
                                new ParallelDeadlineGroup(new SequentialCommandGroup(
                                                new ParallelDeadlineGroup(swerve.followPathCommand(
                                                                "6 Piece Part 7", false)).withTimeout(4.0),
                                                new InstantCommand(() -> swerve.drive(new Translation2d(), 0, true,
                                                                false, 0)),
                                                                                                                new AlignToGoalOnlyOdom(swerve).withTimeout(1.5),


                                                new ShootFalconForced(shooter, 1., 0.6, intake, hood, () -> 25.)),
                                                new RevUp(shooter, 1., .6, () -> 25., hood))
